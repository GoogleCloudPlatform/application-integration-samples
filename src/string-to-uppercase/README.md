...
```
2) Navigate to the `string-to-uppercase` directory
```sh
cd src/string-to-uppercase
```
...
If you are creating a new integration:
    i) Enter a name `string-to-uppercase` and description in the Create Integration dialog.
...
7) In the file browser dialog, select `string-to-uppercase.json`, and then click Open. A new version of the integration is created using the uploaded file.
